...
void CharacterGame::InitVulkanExample(bool enableValidation, PFN_GetEnabledFeatures enabledFeaturesFn)
{
	Game::InitVulkanExample(enableValidation);
	width = 1280;
	height = 720;
	zoom = -2.5f;
...
void CharacterGame::UnInitVulkanExample()
{
...
// memory properties. 
uint32_t CharacterGame::getMemoryTypeIndex(uint32_t typeBits, VkMemoryPropertyFlags properties)
{
...
void CharacterGame::prepareSynchronizationPrimitives()
{
...
VkCommandBuffer CharacterGame::getCommandBuffer(bool begin)
{
...
void CharacterGame::flushCommandBuffer(VkCommandBuffer commandBuffer)
{
...
void CharacterGame::buildCommandBuffers()
{
...
void CharacterGame::prepareVertices(bool useStagingBuffers)
{
...
void CharacterGame::setupDescriptorPool()
{
...
void CharacterGame::setupDescriptorSetLayout()
{
...
void CharacterGame::setupDescriptorSet()
{
...
void CharacterGame::setupDepthStencil()
{
...
// Note: Override of virtual function in the base class and called from within VulkanExampleBase::prepare
void CharacterGame::setupFrameBuffer()
{
...
// Note: Override of virtual function in the base class and called from within VulkanExampleBase::prepare
void CharacterGame::setupRenderPass()
{
...
void CharacterGame::preparePipelines()
{
...
void CharacterGame::prepareUniformBuffers()
{
...
void CharacterGame::updateUniformBuffers()
{
	// Update matrices
...
void CharacterGame::viewChanged()
{
