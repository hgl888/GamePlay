...
void Theme::Style::Overlay::setSkinRegion(const VkRectangle& region, float tw, float th)
{
    GP_ASSERT(_skin);
    _skin->setRegion(region, tw, th);
}

const VkRectangle& Theme::Style::Overlay::getSkinRegion() const
{
    if (_skin)
    {
...
const VkRectangle& Theme::Style::Overlay::getImageRegion(const char* id) const
{
    if (!_imageList)
    {
        return VkRectangle::empty();
...
void Theme::Style::Overlay::setImageRegion(const char* id, const VkRectangle& region, float tw, float th)
{
...
const VkRectangle& Theme::Style::Overlay::getCursorRegion() const
{
    if (_cursor)
    {
...
void Theme::Style::Overlay::setCursorRegion(const VkRectangle& region, float tw, float th)
{
    GP_ASSERT(_cursor);
