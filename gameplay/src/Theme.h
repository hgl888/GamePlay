...
public:
    ...
    public:
         ...
         */
        const VkRectangle& getRegion() const;
    ...
    private:
        ...
        ThemeImage(float tw, float th, const VkRectangle& region, const Vector4& color);
...
private:
    ...
    private:
        ...
        Skin(float tw, float th, const VkRectangle& region, const Theme::Border& border, const Vector4& color);
        ...
        static Skin* create(const char* id, float tw, float th, const VkRectangle& region, const Theme::Border& border, const Vector4& color);

        void setRegion(const VkRectangle& region, float tw, float th);
