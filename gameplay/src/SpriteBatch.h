...
public:
     ...
     */
    void draw(const VkRectangle& dst, const VkRectangle& src, const Vector4& color = Vector4::one());
     ...
     * @param color The color to tint the sprite. Use white for no tint.
     */
    void draw(const Vector3& dst, const VkRectangle& src, const Vector2& scale, const Vector4& color = Vector4::one());
     ...
     */
    void draw(const Vector3& dst, const VkRectangle& src, const Vector2& scale, const Vector4& color,
     ...
     */
    void draw(float x, float y, float width, float height, float u1, float v1, float u2, float v2, const Vector4& color, const VkRectangle& clip);
     ...
     * @param clip The clip rectangle.
     */
    void draw(float x, float y, float z, float width, float height, float u1, float v1, float u2, float v2, const Vector4& color, const VkRectangle& clip);
...
private:
     ...
     * @param vertices The vertices to draw.
     */
    void addSprite(float x, float y, float width, float height, float u1, float v1, float u2, float v2, const Vector4& color, const VkRectangle& clip, SpriteBatch::SpriteVertex* vertices);

    bool clipSprite(const VkRectangle& clip, float& x, float& y, float& width, float& height, float& u1, float& v1, float& u2, float& v2);
