...
public:
     ...
     */
    void drawText(const char* text, const VkRectangle& area, const Vector4& color, unsigned int size = 0,
                  Justify justify = ALIGN_TOP_LEFT, bool wrap = true, bool rightToLeft = false,
                  const VkRectangle& clip = VkRectangle(0, 0, 0, 0));
     ...
     */
    void measureText(const char* text, const VkRectangle& clip, unsigned int size, VkRectangle* out,
     ...
     */
    int getIndexAtLocation(const char* text, const VkRectangle& clip, unsigned int size, const Vector2& inLocation,
     ...
     */
    void getLocationAtIndex(const char* text, const VkRectangle& clip, unsigned int size, Vector2* outLocation,
...
private:
    ...
    void getMeasurementInfo(const char* text, const VkRectangle& area, unsigned int size, Justify justify, bool wrap, bool rightToLeft,
                            std::vector<int>* xPositions, int* yPosition, std::vector<unsigned int>* lineLengths);

    int getIndexOrLocation(const char* text, const VkRectangle& clip, unsigned int size, const Vector2& inLocation, Vector2* outLocation,
    ...
    void addLineInfo(const VkRectangle& area, int lineWidth, int lineLength, Justify hAlign,
