...
private:
    ...
    private:
        ...
        void setSkinRegion(const VkRectangle& region, float tw, float th);

        const VkRectangle& getSkinRegion() const;
        ...
        const VkRectangle& getImageRegion(const char* id) const;

        void setImageRegion(const char* id, const VkRectangle& region, float tw, float th);
        ...
        const VkRectangle& getCursorRegion() const;

        void setCursorRegion(const VkRectangle& region, float tw, float th);
