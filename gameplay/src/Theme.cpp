...
Theme* Theme::getDefault()
{
	if (!__defaultTheme)
	{
        ...
        if (!__defaultTheme)
        {
            ...
            __defaultTheme->_emptyImage = new Theme::ThemeImage(1.0f, 1.0f, VkRectangle::empty(), Vector4::zero());
...
Theme* Theme::create(const char* url)
{
    ...
    theme->_emptyImage = new Theme::ThemeImage(tw, th, VkRectangle::empty(), Vector4::zero());
    ...
    while (space != NULL)
    {
        ...
        else if (strcmpnocase(spacename, "skin") == 0)
        {
            ...
            const VkRectangle region(regionVector.x, regionVector.y, regionVector.z, regionVector.w);
 ...
 * Theme::ThemeImage *
 *********************/
Theme::ThemeImage::ThemeImage(float tw, float th, const VkRectangle& region, const Vector4& color)
...
const VkRectangle& Theme::ThemeImage::getRegion() const
{
    return _region;
}
 ...
 * Theme::Skin *
 ***************/
Theme::Skin* Theme::Skin::create(const char* id, float tw, float th, const VkRectangle& region, const Theme::Border& border, const Vector4& color)
{
...
Theme::Skin::Skin(float tw, float th, const VkRectangle& region, const Theme::Border& border, const Vector4& color)
...
const VkRectangle& Theme::Skin::getRegion() const
{
    return _region;
}

void Theme::Skin::setRegion(const VkRectangle& region, float tw, float th)
{
