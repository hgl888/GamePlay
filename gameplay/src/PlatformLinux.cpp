...
static vk::Keyboard::Key getKey(KeySym sym)
{
    switch (sym)
    {
        case XK_Sys_Req:
            return vk::Keyboard::KEY_SYSREQ;
        case XK_Break:
            return vk::Keyboard::KEY_BREAK;
        case XK_Menu :
            return vk::Keyboard::KEY_MENU;
        case XK_KP_Enter:
            return vk::Keyboard::KEY_KP_ENTER;
        case XK_Pause:
            return vk::Keyboard::KEY_PAUSE;
        case XK_Scroll_Lock:
            return vk::Keyboard::KEY_SCROLL_LOCK;
        case XK_Print:
            return vk::Keyboard::KEY_PRINT;
        case XK_Escape:
            return vk::Keyboard::KEY_ESCAPE;
        case XK_BackSpace:
            return vk::Keyboard::KEY_BACKSPACE;
        case XK_Tab:
            return vk::Keyboard::KEY_TAB;
        case XK_Return:
            return vk::Keyboard::KEY_RETURN;
        case XK_Caps_Lock:
            return vk::Keyboard::KEY_CAPS_LOCK;
        case XK_Shift_L:
        case XK_Shift_R:
            return vk::Keyboard::KEY_SHIFT;
        case XK_Control_L:
        case XK_Control_R:
            return vk::Keyboard::KEY_CTRL;
        case XK_Alt_L:
        case XK_Alt_R:
            return vk::Keyboard::KEY_ALT;
        case XK_Hyper_L:
        case XK_Hyper_R:
            return vk::Keyboard::KEY_HYPER;
        case XK_Insert:
            return vk::Keyboard::KEY_INSERT;
        case XK_Home:
            return vk::Keyboard::KEY_HOME;
        case XK_Page_Up:
            return vk::Keyboard::KEY_PG_UP;
        case XK_Delete:
            return vk::Keyboard::KEY_DELETE;
        case XK_End:
            return vk::Keyboard::KEY_END;
        case XK_Page_Down:
            return vk::Keyboard::KEY_PG_DOWN;
        case XK_Left:
            return vk::Keyboard::KEY_LEFT_ARROW;
        case XK_Right:
            return vk::Keyboard::KEY_RIGHT_ARROW;
        case XK_Up:
            return vk::Keyboard::KEY_UP_ARROW;
        case XK_Down:
            return vk::Keyboard::KEY_DOWN_ARROW;
        case XK_Num_Lock:
            return vk::Keyboard::KEY_NUM_LOCK;
        case XK_KP_Add:
            return vk::Keyboard::KEY_KP_PLUS;
        case XK_KP_Subtract:
            return vk::Keyboard::KEY_KP_MINUS;
        case XK_KP_Multiply:
            return vk::Keyboard::KEY_KP_MULTIPLY;
        case XK_KP_Divide:
            return vk::Keyboard::KEY_KP_DIVIDE;
        case XK_KP_Home:
            return vk::Keyboard::KEY_KP_HOME;
        case XK_KP_Up:
            return vk::Keyboard::KEY_KP_UP;
        case XK_KP_Page_Up:
            return vk::Keyboard::KEY_KP_PG_UP;
        case XK_KP_Left:
            return vk::Keyboard::KEY_KP_LEFT;
        case XK_KP_5:
            return vk::Keyboard::KEY_KP_FIVE;
        case XK_KP_Right:
            return vk::Keyboard::KEY_KP_RIGHT;
        case XK_KP_End:
            return vk::Keyboard::KEY_KP_END;
        case XK_KP_Down:
            return vk::Keyboard::KEY_KP_DOWN;
        case XK_KP_Page_Down:
            return vk::Keyboard::KEY_KP_PG_DOWN;
        case XK_KP_Insert:
            return vk::Keyboard::KEY_KP_INSERT;
        case XK_KP_Delete:
            return vk::Keyboard::KEY_KP_DELETE;
        case XK_F1:
            return vk::Keyboard::KEY_F1;
        case XK_F2:
            return vk::Keyboard::KEY_F2;
        case XK_F3:
            return vk::Keyboard::KEY_F3;
        case XK_F4:
            return vk::Keyboard::KEY_F4;
        case XK_F5:
            return vk::Keyboard::KEY_F5;
        case XK_F6:
            return vk::Keyboard::KEY_F6;
        case XK_F7:
            return vk::Keyboard::KEY_F7;
        case XK_F8:
            return vk::Keyboard::KEY_F8;
        case XK_F9:
            return vk::Keyboard::KEY_F9;
        case XK_F10:
            return vk::Keyboard::KEY_F10;
        case XK_F11:
            return vk::Keyboard::KEY_F11;
        case XK_F12:
            return vk::Keyboard::KEY_F12;
        case XK_KP_Space:
        case XK_space:
            return vk::Keyboard::KEY_SPACE;
        case XK_parenright:
            return vk::Keyboard::KEY_RIGHT_PARENTHESIS;
        case XK_0:
            return vk::Keyboard::KEY_ZERO;
        case XK_exclam:
            return vk::Keyboard::KEY_EXCLAM;
        case XK_1:
            return vk::Keyboard::KEY_ONE;
        case XK_at:
            return vk::Keyboard::KEY_AT;
        case XK_2:
            return vk::Keyboard::KEY_TWO;
        case XK_numbersign:
            return vk::Keyboard::KEY_NUMBER;
        case XK_3:
            return vk::Keyboard::KEY_THREE;
        case XK_dollar:
            return vk::Keyboard::KEY_DOLLAR;
        case XK_4:
            return vk::Keyboard::KEY_FOUR;
        case XK_percent:
        case XK_asciicircum :
            return vk::Keyboard::KEY_CIRCUMFLEX;
            return vk::Keyboard::KEY_PERCENT;
        case XK_5:
            return vk::Keyboard::KEY_FIVE;
        case XK_6:
            return vk::Keyboard::KEY_SIX;
        case XK_ampersand:
            return vk::Keyboard::KEY_AMPERSAND;
        case XK_7:
            return vk::Keyboard::KEY_SEVEN;
        case XK_asterisk:
            return vk::Keyboard::KEY_ASTERISK;
        case XK_8:
            return vk::Keyboard::KEY_EIGHT;
        case XK_parenleft:
            return vk::Keyboard::KEY_LEFT_PARENTHESIS;
        case XK_9:
            return vk::Keyboard::KEY_NINE;
        case XK_equal:
            return vk::Keyboard::KEY_EQUAL;
        case XK_plus:
            return vk::Keyboard::KEY_PLUS;
        case XK_less:
            return vk::Keyboard::KEY_LESS_THAN;
        case XK_comma:
            return vk::Keyboard::KEY_COMMA;
        case XK_underscore:
            return vk::Keyboard::KEY_UNDERSCORE;
        case XK_minus:
            return vk::Keyboard::KEY_MINUS;
        case XK_greater:
            return vk::Keyboard::KEY_GREATER_THAN;
        case XK_period:
            return vk::Keyboard::KEY_PERIOD;
        case XK_colon:
            return vk::Keyboard::KEY_COLON;
        case XK_semicolon:
            return vk::Keyboard::KEY_SEMICOLON;
        case XK_question:
            return vk::Keyboard::KEY_QUESTION;
        case XK_slash:
            return vk::Keyboard::KEY_SLASH;
        case XK_grave:
            return vk::Keyboard::KEY_GRAVE;
        case XK_asciitilde:
            return vk::Keyboard::KEY_TILDE;
        case XK_braceleft:
            return vk::Keyboard::KEY_LEFT_BRACE;
        case XK_bracketleft:
            return vk::Keyboard::KEY_LEFT_BRACKET;
        case XK_bar:
            return vk::Keyboard::KEY_BAR;
        case XK_backslash:
            return vk::Keyboard::KEY_BACK_SLASH;
        case XK_braceright:
            return vk::Keyboard::KEY_RIGHT_BRACE;
        case XK_bracketright:
            return vk::Keyboard::KEY_RIGHT_BRACKET;
        case XK_quotedbl:
            return vk::Keyboard::KEY_QUOTE;
        case XK_apostrophe:
            return vk::Keyboard::KEY_APOSTROPHE;
        case XK_EuroSign:
            return vk::Keyboard::KEY_EURO;
        case XK_sterling:
            return vk::Keyboard::KEY_POUND;
        case XK_yen:
            return vk::Keyboard::KEY_YEN;
        case XK_periodcentered:
            return vk::Keyboard::KEY_MIDDLE_DOT;
        case XK_A:
            return vk::Keyboard::KEY_CAPITAL_A;
        case XK_a:
            return vk::Keyboard::KEY_A;
        case XK_B:
            return vk::Keyboard::KEY_CAPITAL_B;
        case XK_b:
            return vk::Keyboard::KEY_B;
        case XK_C:
            return vk::Keyboard::KEY_CAPITAL_C;
        case XK_c:
            return vk::Keyboard::KEY_C;
        case XK_D:
            return vk::Keyboard::KEY_CAPITAL_D;
        case XK_d:
            return vk::Keyboard::KEY_D;
        case XK_E:
            return vk::Keyboard::KEY_CAPITAL_E;
        case XK_e:
            return vk::Keyboard::KEY_E;
        case XK_F:
            return vk::Keyboard::KEY_CAPITAL_F;
        case XK_f:
            return vk::Keyboard::KEY_F;
        case XK_G:
            return vk::Keyboard::KEY_CAPITAL_G;
        case XK_g:
            return vk::Keyboard::KEY_G;
        case XK_H:
            return vk::Keyboard::KEY_CAPITAL_H;
        case XK_h:
            return vk::Keyboard::KEY_H;
        case XK_I:
            return vk::Keyboard::KEY_CAPITAL_I;
        case XK_i:
            return vk::Keyboard::KEY_I;
        case XK_J:
            return vk::Keyboard::KEY_CAPITAL_J;
        case XK_j:
            return vk::Keyboard::KEY_J;
        case XK_K:
            return vk::Keyboard::KEY_CAPITAL_K;
        case XK_k:
            return vk::Keyboard::KEY_K;
        case XK_L:
            return vk::Keyboard::KEY_CAPITAL_L;
        case XK_l:
            return vk::Keyboard::KEY_L;
        case XK_M:
            return vk::Keyboard::KEY_CAPITAL_M;
        case XK_m:
            return vk::Keyboard::KEY_M;
        case XK_N:
            return vk::Keyboard::KEY_CAPITAL_N;
        case XK_n:
            return vk::Keyboard::KEY_N;
        case XK_O:
            return vk::Keyboard::KEY_CAPITAL_O;
        case XK_o:
            return vk::Keyboard::KEY_O;
        case XK_P:
            return vk::Keyboard::KEY_CAPITAL_P;
        case XK_p:
            return vk::Keyboard::KEY_P;
        case XK_Q:
            return vk::Keyboard::KEY_CAPITAL_Q;
        case XK_q:
            return vk::Keyboard::KEY_Q;
        case XK_R:
            return vk::Keyboard::KEY_CAPITAL_R;
        case XK_r:
            return vk::Keyboard::KEY_R;
        case XK_S:
            return vk::Keyboard::KEY_CAPITAL_S;
        case XK_s:
            return vk::Keyboard::KEY_S;
        case XK_T:
            return vk::Keyboard::KEY_CAPITAL_T;
        case XK_t:
            return vk::Keyboard::KEY_T;
        case XK_U:
            return vk::Keyboard::KEY_CAPITAL_U;
        case XK_u:
            return vk::Keyboard::KEY_U;
        case XK_V:
            return vk::Keyboard::KEY_CAPITAL_V;
        case XK_v:
            return vk::Keyboard::KEY_V;
        case XK_W:
            return vk::Keyboard::KEY_CAPITAL_W;
        case XK_w:
            return vk::Keyboard::KEY_W;
        case XK_X:
            return vk::Keyboard::KEY_CAPITAL_X;
        case XK_x:
            return vk::Keyboard::KEY_X;
        case XK_Y:
            return vk::Keyboard::KEY_CAPITAL_Y;
        case XK_y:
            return vk::Keyboard::KEY_Y;
        case XK_Z:
            return vk::Keyboard::KEY_CAPITAL_Z;
        case XK_z:
            return vk::Keyboard::KEY_Z;
        default:
            return vk::Keyboard::KEY_NONE;
    }
}
 ...
 */
static int getUnicode(vk::Keyboard::Key key)
{
    switch (key)
    {
        case vk::Keyboard::KEY_BACKSPACE:
            return 0x0008;
        case vk::Keyboard::KEY_TAB:
            return 0x0009;
        case vk::Keyboard::KEY_RETURN:
        case vk::Keyboard::KEY_KP_ENTER:
            return 0x000A;
        case vk::Keyboard::KEY_ESCAPE:
            return 0x001B;
        case vk::Keyboard::KEY_SPACE:
        case vk::Keyboard::KEY_EXCLAM:
        case vk::Keyboard::KEY_QUOTE:
        case vk::Keyboard::KEY_NUMBER:
        case vk::Keyboard::KEY_DOLLAR:
        case vk::Keyboard::KEY_PERCENT:
        case vk::Keyboard::KEY_CIRCUMFLEX:
        case vk::Keyboard::KEY_AMPERSAND:
        case vk::Keyboard::KEY_APOSTROPHE:
        case vk::Keyboard::KEY_LEFT_PARENTHESIS:
        case vk::Keyboard::KEY_RIGHT_PARENTHESIS:
        case vk::Keyboard::KEY_ASTERISK:
        case vk::Keyboard::KEY_PLUS:
        case vk::Keyboard::KEY_COMMA:
        case vk::Keyboard::KEY_MINUS:
        case vk::Keyboard::KEY_PERIOD:
        case vk::Keyboard::KEY_SLASH:
        case vk::Keyboard::KEY_ZERO:
        case vk::Keyboard::KEY_ONE:
        case vk::Keyboard::KEY_TWO:
        case vk::Keyboard::KEY_THREE:
        case vk::Keyboard::KEY_FOUR:
        case vk::Keyboard::KEY_FIVE:
        case vk::Keyboard::KEY_SIX:
        case vk::Keyboard::KEY_SEVEN:
        case vk::Keyboard::KEY_EIGHT:
        case vk::Keyboard::KEY_NINE:
        case vk::Keyboard::KEY_COLON:
        case vk::Keyboard::KEY_SEMICOLON:
        case vk::Keyboard::KEY_LESS_THAN:
        case vk::Keyboard::KEY_EQUAL:
        case vk::Keyboard::KEY_GREATER_THAN:
        case vk::Keyboard::KEY_QUESTION:
        case vk::Keyboard::KEY_AT:
        case vk::Keyboard::KEY_CAPITAL_A:
        case vk::Keyboard::KEY_CAPITAL_B:
        case vk::Keyboard::KEY_CAPITAL_C:
        case vk::Keyboard::KEY_CAPITAL_D:
        case vk::Keyboard::KEY_CAPITAL_E:
        case vk::Keyboard::KEY_CAPITAL_F:
        case vk::Keyboard::KEY_CAPITAL_G:
        case vk::Keyboard::KEY_CAPITAL_H:
        case vk::Keyboard::KEY_CAPITAL_I:
        case vk::Keyboard::KEY_CAPITAL_J:
        case vk::Keyboard::KEY_CAPITAL_K:
        case vk::Keyboard::KEY_CAPITAL_L:
        case vk::Keyboard::KEY_CAPITAL_M:
        case vk::Keyboard::KEY_CAPITAL_N:
        case vk::Keyboard::KEY_CAPITAL_O:
        case vk::Keyboard::KEY_CAPITAL_P:
        case vk::Keyboard::KEY_CAPITAL_Q:
        case vk::Keyboard::KEY_CAPITAL_R:
        case vk::Keyboard::KEY_CAPITAL_S:
        case vk::Keyboard::KEY_CAPITAL_T:
        case vk::Keyboard::KEY_CAPITAL_U:
        case vk::Keyboard::KEY_CAPITAL_V:
        case vk::Keyboard::KEY_CAPITAL_W:
        case vk::Keyboard::KEY_CAPITAL_X:
        case vk::Keyboard::KEY_CAPITAL_Y:
        case vk::Keyboard::KEY_CAPITAL_Z:
        case vk::Keyboard::KEY_LEFT_BRACKET:
        case vk::Keyboard::KEY_BACK_SLASH:
        case vk::Keyboard::KEY_RIGHT_BRACKET:
        case vk::Keyboard::KEY_UNDERSCORE:
        case vk::Keyboard::KEY_GRAVE:
        case vk::Keyboard::KEY_A:
        case vk::Keyboard::KEY_B:
        case vk::Keyboard::KEY_C:
        case vk::Keyboard::KEY_D:
        case vk::Keyboard::KEY_E:
        case vk::Keyboard::KEY_F:
        case vk::Keyboard::KEY_G:
        case vk::Keyboard::KEY_H:
        case vk::Keyboard::KEY_I:
        case vk::Keyboard::KEY_J:
        case vk::Keyboard::KEY_K:
        case vk::Keyboard::KEY_L:
        case vk::Keyboard::KEY_M:
        case vk::Keyboard::KEY_N:
        case vk::Keyboard::KEY_O:
        case vk::Keyboard::KEY_P:
        case vk::Keyboard::KEY_Q:
        case vk::Keyboard::KEY_R:
        case vk::Keyboard::KEY_S:
        case vk::Keyboard::KEY_T:
        case vk::Keyboard::KEY_U:
        case vk::Keyboard::KEY_V:
        case vk::Keyboard::KEY_W:
        case vk::Keyboard::KEY_X:
        case vk::Keyboard::KEY_Y:
        case vk::Keyboard::KEY_Z:
        case vk::Keyboard::KEY_LEFT_BRACE:
        case vk::Keyboard::KEY_BAR:
        case vk::Keyboard::KEY_RIGHT_BRACE:
        case vk::Keyboard::KEY_TILDE:
            return key;
        default:
            return 0;
    }
        ...
        while (XPending(__display))
        {
            ...
            switch (evt.type)
            {
                ...
                case ConfigureNotify:
                    {
                        updateWindowSize();
                        vk::Platform::resizeEventInternal(evt.xconfigure.width, evt.xconfigure.height);
                    }
                    break;
                ...
                case KeyPress:
                    {
                        ...
                        vk::Platform::keyEventInternal(vk::Keyboard::KEY_PRESS, key);
                        ...
                        if (int character = getUnicode(key))
                            vk::Platform::keyEventInternal(vk::Keyboard::KEY_CHAR, character);
                ...
                case KeyRelease:
                    {
                        ...
                        Keyboard::Key key = getKey(sym);
                        vk::Platform::keyEventInternal(vk::Keyboard::KEY_RELEASE, key);
                ...
                case ButtonPress:
                    {
                        vk::Mouse::MouseEvent mouseEvt;

                        if (evt.xbutton.button >= 1 && evt.xbutton.button <= 3)
                        {
                            if (evt.xbutton.button == 1)
                                mouseEvt = vk::Mouse::MOUSE_PRESS_LEFT_BUTTON;
                            else if (evt.xbutton.button == 2)
                                mouseEvt = vk::Mouse::MOUSE_PRESS_MIDDLE_BUTTON;
                            else if (evt.xbutton.button == 3)
                                mouseEvt = vk::Mouse::MOUSE_PRESS_RIGHT_BUTTON;

                            if (!vk::Platform::mouseEventInternal(mouseEvt, evt.xbutton.x, evt.xbutton.y, 0))
                            {
                                vk::Platform::touchEventInternal(vk::Touch::TOUCH_PRESS, evt.xbutton.x, evt.xbutton.y, 0, true);
                            }
                        }
                        else if (evt.xbutton.button >= 4 && evt.xbutton.button <= 5)
                        {
                            ...
                            vk::Platform::mouseEventInternal(vk::Mouse::MOUSE_WHEEL, evt.xbutton.x, evt.xbutton.y, wheelDelta);
                        }
                    }
                    break;
                ...
                case ButtonRelease:
                    {
                        ...
                        {
                            if (evt.xbutton.button == 1)
                                mouseEvt = vk::Mouse::MOUSE_RELEASE_LEFT_BUTTON;
                            else if (evt.xbutton.button == 2)
                                mouseEvt = vk::Mouse::MOUSE_RELEASE_MIDDLE_BUTTON;
                            else if (evt.xbutton.button == 3)
                                mouseEvt = vk::Mouse::MOUSE_RELEASE_RIGHT_BUTTON;

                            if (!vk::Platform::mouseEventInternal(mouseEvt, evt.xbutton.x, evt.xbutton.y, 0))
                            {
                                vk::Platform::touchEventInternal(vk::Touch::TOUCH_RELEASE, evt.xbutton.x, evt.xbutton.y, 0, true);
                            }
                        }
                    }
                    break;
                ...
                case MotionNotify:
                    {
                        ...
                        if (!vk::Platform::mouseEventInternal(vk::Mouse::MOUSE_MOVE, x, y, 0))
                        {
                            if (evt.xmotion.state & Button1Mask)
                            {
                                vk::Platform::touchEventInternal(vk::Touch::TOUCH_MOVE, x, y, 0, true);
                            }
                        }
                    }
                    break;
