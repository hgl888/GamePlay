...
void SpriteBatch::draw(const VkRectangle& dst, const VkRectangle& src, const Vector4& color)
{
    // Calculate uvs.
...
void SpriteBatch::draw(const Vector3& dst, const VkRectangle& src, const Vector2& scale, const Vector4& color)
{
    // Calculate uvs.
    float u1 = _textureWidthRatio * src.x;
    float v1 = 1.0f - _textureHeightRatio * src.y;
...
void SpriteBatch::draw(float x, float y, float width, float height, float u1, float v1, float u2, float v2, const Vector4& color, const VkRectangle& clip)
{
    draw(x, y, 0, width, height, u1, v1, u2, v2, color, clip);
}

void SpriteBatch::draw(float x, float y, float z, float width, float height, float u1, float v1, float u2, float v2, const Vector4& color, const VkRectangle& clip)
{
...
void SpriteBatch::addSprite(float x, float y, float width, float height, float u1, float v1, float u2, float v2, const Vector4& color, const VkRectangle& clip, SpriteBatch::SpriteVertex* vertices)
{
    GP_ASSERT(vertices);
...
bool SpriteBatch::clipSprite(const VkRectangle& clip, float& x, float& y, float& width, float& height, float& u1, float& v1, float& u2, float& v2)
{
