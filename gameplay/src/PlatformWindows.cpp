...
static vk::Keyboard::Key getKey(WPARAM win32KeyCode, bool shiftDown)
{
    switch (win32KeyCode)
    {
    case VK_PAUSE:
    ...
    case VK_TAB:
        return shiftDown ? vk::Keyboard::KEY_BACK_TAB : vk::Keyboard::KEY_TAB;
    case VK_RETURN:
    ...
    case 0x30:
        return shiftDown ? vk::Keyboard::KEY_RIGHT_PARENTHESIS : vk::Keyboard::KEY_ZERO;
    case 0x31:
        return shiftDown ? vk::Keyboard::KEY_EXCLAM : vk::Keyboard::KEY_ONE;
    case 0x32:
        return shiftDown ? vk::Keyboard::KEY_AT : vk::Keyboard::KEY_TWO;
    case 0x33:
        return shiftDown ? vk::Keyboard::KEY_NUMBER : vk::Keyboard::KEY_THREE;
    case 0x34:
        return shiftDown ? vk::Keyboard::KEY_DOLLAR : vk::Keyboard::KEY_FOUR;
    case 0x35:
        return shiftDown ? vk::Keyboard::KEY_PERCENT : vk::Keyboard::KEY_FIVE;
    case 0x36:
        return shiftDown ? vk::Keyboard::KEY_CIRCUMFLEX : vk::Keyboard::KEY_SIX;
    case 0x37:
        return shiftDown ? vk::Keyboard::KEY_AMPERSAND : vk::Keyboard::KEY_SEVEN;
    case 0x38:
        return shiftDown ? vk::Keyboard::KEY_ASTERISK : vk::Keyboard::KEY_EIGHT;
    case 0x39:
        return shiftDown ? vk::Keyboard::KEY_LEFT_PARENTHESIS : vk::Keyboard::KEY_NINE;
    case VK_OEM_PLUS:
        return shiftDown ? vk::Keyboard::KEY_EQUAL : vk::Keyboard::KEY_PLUS;
    case VK_OEM_COMMA:
        return shiftDown ? vk::Keyboard::KEY_LESS_THAN : vk::Keyboard::KEY_COMMA;
    case VK_OEM_MINUS:
        return shiftDown ? vk::Keyboard::KEY_UNDERSCORE : vk::Keyboard::KEY_MINUS;
    case VK_OEM_PERIOD:
        return shiftDown ? vk::Keyboard::KEY_GREATER_THAN : vk::Keyboard::KEY_PERIOD;
    case VK_OEM_1:
        return shiftDown ? vk::Keyboard::KEY_COLON : vk::Keyboard::KEY_SEMICOLON;
    case VK_OEM_2:
        return shiftDown ? vk::Keyboard::KEY_QUESTION : vk::Keyboard::KEY_SLASH;
    case VK_OEM_3:
        return shiftDown ? vk::Keyboard::KEY_TILDE : vk::Keyboard::KEY_GRAVE;
    case VK_OEM_4:
        return shiftDown ? vk::Keyboard::KEY_LEFT_BRACE : vk::Keyboard::KEY_LEFT_BRACKET;
    case VK_OEM_5:
        return shiftDown ? vk::Keyboard::KEY_BAR : vk::Keyboard::KEY_BACK_SLASH;
    case VK_OEM_6:
        return shiftDown ? vk::Keyboard::KEY_RIGHT_BRACE : vk::Keyboard::KEY_RIGHT_BRACKET;
    case VK_OEM_7:
        return shiftDown ? vk::Keyboard::KEY_QUOTE : vk::Keyboard::KEY_APOSTROPHE;
    case 0x41:
        return shiftDown ? vk::Keyboard::KEY_CAPITAL_A : vk::Keyboard::KEY_A;
    case 0x42:
        return shiftDown ? vk::Keyboard::KEY_CAPITAL_B : vk::Keyboard::KEY_B;
    case 0x43:
        return shiftDown ? vk::Keyboard::KEY_CAPITAL_C : vk::Keyboard::KEY_C;
    case 0x44:
        return shiftDown ? vk::Keyboard::KEY_CAPITAL_D : vk::Keyboard::KEY_D;
    case 0x45:
        return shiftDown ? vk::Keyboard::KEY_CAPITAL_E : vk::Keyboard::KEY_E;
    case 0x46:
        return shiftDown ? vk::Keyboard::KEY_CAPITAL_F : vk::Keyboard::KEY_F;
    case 0x47:
        return shiftDown ? vk::Keyboard::KEY_CAPITAL_G : vk::Keyboard::KEY_G;
    case 0x48:
        return shiftDown ? vk::Keyboard::KEY_CAPITAL_H : vk::Keyboard::KEY_H;
    case 0x49:
        return shiftDown ? vk::Keyboard::KEY_CAPITAL_I : vk::Keyboard::KEY_I;
    case 0x4A:
        return shiftDown ? vk::Keyboard::KEY_CAPITAL_J : vk::Keyboard::KEY_J;
    case 0x4B:
        return shiftDown ? vk::Keyboard::KEY_CAPITAL_K : vk::Keyboard::KEY_K;
    case 0x4C:
        return shiftDown ? vk::Keyboard::KEY_CAPITAL_L : vk::Keyboard::KEY_L;
    case 0x4D:
        return shiftDown ? vk::Keyboard::KEY_CAPITAL_M : vk::Keyboard::KEY_M;
    case 0x4E:
        return shiftDown ? vk::Keyboard::KEY_CAPITAL_N : vk::Keyboard::KEY_N;
    case 0x4F:
        return shiftDown ? vk::Keyboard::KEY_CAPITAL_O : vk::Keyboard::KEY_O;
    case 0x50:
        return shiftDown ? vk::Keyboard::KEY_CAPITAL_P : vk::Keyboard::KEY_P;
    case 0x51:
        return shiftDown ? vk::Keyboard::KEY_CAPITAL_Q : vk::Keyboard::KEY_Q;
    case 0x52:
        return shiftDown ? vk::Keyboard::KEY_CAPITAL_R : vk::Keyboard::KEY_R;
    case 0x53:
        return shiftDown ? vk::Keyboard::KEY_CAPITAL_S : vk::Keyboard::KEY_S;
    case 0x54:
        return shiftDown ? vk::Keyboard::KEY_CAPITAL_T : vk::Keyboard::KEY_T;
    case 0x55:
        return shiftDown ? vk::Keyboard::KEY_CAPITAL_U : vk::Keyboard::KEY_U;
    case 0x56:
        return shiftDown ? vk::Keyboard::KEY_CAPITAL_V : vk::Keyboard::KEY_V;
    case 0x57:
        return shiftDown ? vk::Keyboard::KEY_CAPITAL_W : vk::Keyboard::KEY_W;
    case 0x58:
        return shiftDown ? vk::Keyboard::KEY_CAPITAL_X : vk::Keyboard::KEY_X;
    case 0x59:
        return shiftDown ? vk::Keyboard::KEY_CAPITAL_Y : vk::Keyboard::KEY_Y;
    case 0x5A:
        return shiftDown ? vk::Keyboard::KEY_CAPITAL_Z : vk::Keyboard::KEY_Z;
    default:
...
LRESULT CALLBACK __WndProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_LBUTTONDOWN:
    {
        ...
        if (!vk::Platform::mouseEventInternal(vk::Mouse::MOUSE_PRESS_LEFT_BUTTON, x, y, 0))
        {
            vk::Platform::touchEventInternal(vk::Touch::TOUCH_PRESS, x, y, 0, true);
        }
        return 0;
    }
    case WM_LBUTTONUP:
    {
        ...
        if (!vk::Platform::mouseEventInternal(vk::Mouse::MOUSE_RELEASE_LEFT_BUTTON, x, y, 0))
        {
            vk::Platform::touchEventInternal(vk::Touch::TOUCH_RELEASE, x, y, 0, true);
        }
        UpdateCapture(wParam);
        return 0;
    }
    case WM_RBUTTONDOWN:
        UpdateCapture(wParam);
        vk::Platform::mouseEventInternal(vk::Mouse::MOUSE_PRESS_RIGHT_BUTTON, GET_X_LPARAM(lParam), GET_Y_LPARAM(lParam), 0);
        break;

    case WM_RBUTTONUP:
        vk::Platform::mouseEventInternal(vk::Mouse::MOUSE_RELEASE_RIGHT_BUTTON, GET_X_LPARAM(lParam), GET_Y_LPARAM(lParam), 0);
        UpdateCapture(wParam);
        break;

    case WM_MBUTTONDOWN:
        UpdateCapture(wParam);
        vk::Platform::mouseEventInternal(vk::Mouse::MOUSE_PRESS_MIDDLE_BUTTON, GET_X_LPARAM(lParam), GET_Y_LPARAM(lParam), 0);
        break;

    case WM_MBUTTONUP:
        vk::Platform::mouseEventInternal(vk::Mouse::MOUSE_RELEASE_MIDDLE_BUTTON, GET_X_LPARAM(lParam), GET_Y_LPARAM(lParam), 0);
        UpdateCapture(wParam);
        break;
    ...
    case WM_KEYDOWN:
        ...
        vk::Platform::keyEventInternal(vk::Keyboard::KEY_PRESS, getKey(wParam, shiftDown ^ capsOn));
        break;
    ...
    case WM_KEYUP:
        ...
        vk::Platform::keyEventInternal(vk::Keyboard::KEY_RELEASE, getKey(wParam, shiftDown ^ capsOn));
        break;

    case WM_CHAR:
        vk::Platform::keyEventInternal(vk::Keyboard::KEY_CHAR, wParam);
        break;
    ...
    case WM_SIZE:
        // Window was resized.
        vk::Platform::resizeEventInternal((unsigned int)(short)LOWORD(lParam), (unsigned int)(short)HIWORD(lParam));
        break;
    }
