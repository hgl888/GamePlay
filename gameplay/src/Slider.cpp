...
void Slider::updateValue(int x, int y)
{
    ...
    const VkRectangle& minCapRegion = _minImage->getRegion();
    const VkRectangle& maxCapRegion = _maxImage->getRegion();
    const VkRectangle& markerRegion = _markerImage->getRegion();
...
unsigned int Slider::drawImages(Form* form, const VkRectangle& clip)
{
    ...
    const VkRectangle& maxCapRegion = _maxImage->getRegion();
    const VkRectangle& markerRegion = _markerImage->getRegion();
    const VkRectangle& trackRegion = _trackImage->getRegion();
...
unsigned int Slider::drawText(Form* form, const VkRectangle& clip)
{
