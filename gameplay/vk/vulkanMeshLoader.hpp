	...
	*/
	...
	public:
		...
		void drawIndexed(VkCommandBuffer cmdBuffer)
		{
			...
			vkCmdBindVertexBuffers(cmdBuffer, vertexBufferBinding, 1, &mMeshBuffers.vertices.buf, offsets);
			vkCmdBindIndexBuffer(cmdBuffer, mMeshBuffers.indices.buf, 0, VK_INDEX_TYPE_UINT32);
			vkCmdDrawIndexed(cmdBuffer, mMeshBuffers.indexCount, 1, 0, 0, 0);
		}
	};
